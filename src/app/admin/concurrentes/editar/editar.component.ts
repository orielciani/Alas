...
export class EditarComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.concurrentesservice.cargarUno(this.id).subscribe((respuesta: any) => {
      this.concurrente = respuesta.concurrente;
    //  this.setValue(respuesta.concurrente.nombre, respuesta.concurrente.email, respuesta.concurrente.role, null);
    });
  }

  // setValue(nombre: string,) {
  //   let user = {
  //     nombre: nombre,
  //     email: email,
  //     role: role,
...
crearUsuario(concurrente: any) {
  ...
  this.concurrentesservice.editar(this.id, user).subscribe((respuesta: any) => {
    Swal.fire(
      'Exito',
